...
//Если число не попадает в диапазон от 1 до 10 - выводит 
//ниже текст "число вне диапазона от 1 до 10".
//Если число попадает в диапазон от 1 до 10 - сделать 
//запрос с помощью XHR по URL https://picsum.photos/v2/list?limit=10, 
//где get-параметр limit — это введённое число.

//Пример: если пользователь ввёл 5, 
//то запрос будет вида https://picsum.photos/v2/list?limit=5.
